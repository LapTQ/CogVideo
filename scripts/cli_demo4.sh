...
PATHD_OUTPUT=/home/lap_awlv/CogVideo/outputs/cogvideo_4
mkdir -p $PATHD_OUTPUT

CUDA_VISIBLE_DEVICES=3 python3 inference/cli_demo.py \
    ...
    --fps 8 \
    --dtype bfloat16 \
    --image_or_video_path /home/lap_awlv/CogVideo/outputs/gen-images/gen18.png \
