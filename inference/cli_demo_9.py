...
if __name__ == "__main__":
    ...
    ls_prompts = [
        ...
        "In a wide surveillance shot, a man stands stationary. He examines a product, unzips his crossbody bag, shifts his weight to one leg, and slides the item in while keeping his posture relaxed. The surveillance camera is far away and static across frames, always capturing the whole body of the person in every frame.",
        
        "Seen from a far static surveillance camera, a man grabs a product, examines it briefly, then shifts slightly to unzip his shoulder bag and insert the item carefully inside. The surveillance camera is far away and static across frames, always capturing the whole body of the person in every frame.",
                
        "Captured from a far, motionless angle, a man lifts a product, leans a little, opens his shoulder bag flap with one hand, and places the product in while standing still. The surveillance camera is far away and static across frames, always capturing the whole body of the person in every frame.",
        
        "In a still wide surveillance frame, a man reaches for a product, inspects it, slowly opens his shoulder bag with one hand, and carefully inserts the item while standing steady. The surveillance camera is far away and static across frames, always capturing the whole body of the person in every frame.",
    ]
